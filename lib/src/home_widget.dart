...
import 'package:home_widget_vconnex/src/home_widget_callback_dispatcher.dart';
import 'package:home_widget_vconnex/src/home_widget_info.dart';


/// A Flutter Plugin to simplify setting up and communicating with HomeScreenWidgets
class HomeWidget {
  static const MethodChannel _channel = MethodChannel('home_widget_vconex_custom');
  static const EventChannel _eventChannel = EventChannel('home_widget_vconex/updates');
