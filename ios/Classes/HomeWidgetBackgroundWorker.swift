...
public struct HomeWidgetBackgroundWorker {
  ...
  static let dispatcherKey: String = "home_widget_vconex.internal.background.dispatcher"
  static let callbackKey: String = "home_widget_vconex.internal.background.callback"
  ...
  static func setupEngine(dispatcher: Int64) {
    engine = FlutterEngine(
      name: "home_widget_vconex_background", project: nil, allowHeadlessExecution: true)

    channel = FlutterMethodChannel(
      name: "home_widget_vconex/background", binaryMessenger: engine!.binaryMessenger,
    ...
    if registerPlugins != nil {
     ...
     HomeWidgetPluginVconex.register(with: engine!.registrar(forPlugin: "home_widget_vconex_background")!)
    }
