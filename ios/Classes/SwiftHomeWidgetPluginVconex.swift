...
public class SwiftHomeWidgetPluginVconex: NSObject, FlutterPlugin, FlutterStreamHandler {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let instance = SwiftHomeWidgetPluginVconex()

    let channel = FlutterMethodChannel(name: "home_widget_vconex_custom", binaryMessenger: registrar.messenger())
    registrar.addMethodCallDelegate(instance, channel: channel)

    let eventChannel = FlutterEventChannel(
      name: "home_widget_vconex/updates", binaryMessenger: registrar.messenger())
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    if call.method == "setAppGroupId" {
      ...
      {
        SwiftHomeWidgetPluginVconex.groupId = groupId
        result(true)
      } else {
        result(
          FlutterError(
      ...
      if SwiftHomeWidgetPluginVconex.groupId == nil {
      ...
      {
        let preferences = UserDefaults.init(suiteName: SwiftHomeWidgetPluginVconex.groupId)
        if data != nil {
